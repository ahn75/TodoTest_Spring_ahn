	...
	<form id='update_form' onsubmit='return update()' method='post'>
		<table>
			...
			<tr>
				...
				<td><input id='mem_id' type='text' name='userid'
			...
			<tr>
				<td>회원 E-mail</td>
				<td><input id='mem_email' type='text' name='member_email'
					value='${member.member_email }' required></td>
			</tr>
			
			<tr>
				<td colspan=2 style="text-align: center"><input
					id='update_button' type='submit' value='수정'> <input
					id='cancle_button' type='button' value='취소' onclick='cancel()'>
				</td>
			</tr>
		</table>
	</form>
